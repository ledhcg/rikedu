...
import 'package:rike/src/features/parental_controls/views/battery.dart';
import 'package:rike/src/features/parental_controls/views/map.dart';

void main() async {
  WidgetsFlutterBinding.ensureInitialized();
  await Firebase.initializeApp();
  runApp(MaterialApp(home: TestRealtimeLocation()));
}
